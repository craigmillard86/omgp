...
def test_review_followups_wiring():
    ...
    assert "duplicates open task" in script and "CAP" in script   # dedup + runaway cap
    # The disclosure is not a follow-up list (2026-09-08): the stop test must survive the marker
