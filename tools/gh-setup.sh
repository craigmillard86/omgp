...
L auto-fix-1      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; label COUNT vs auto_fix_max_attempts is the bound — the index is a free slot, not the attempt ordinal)"
L auto-fix-2      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; label count vs auto_fix_max_attempts is the bound)"
L auto-fix-3      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; label count vs auto_fix_max_attempts is the bound)"
L auto-fix-4      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; at the bound the next failure escalates needs-human)"
L auto-fix-5      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; reachable only when auto_fix_max_attempts > 4)"
L auto-fix-6      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; reachable only when auto_fix_max_attempts > 4)"
L auto-fix-7      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; reachable only when auto_fix_max_attempts > 4)"
L auto-fix-8      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; reachable only when auto_fix_max_attempts > 4)"
L auto-fix-9      "FBCA04" "CI auto-fix attempt marker (ci-failure-router; reachable only when auto_fix_max_attempts > 4)"
L auto-fix-10     "FBCA04" "CI auto-fix attempt marker (ci-failure-router; the knob clamps here — no higher label is reachable)"
L review-fix-1    "FBCA04" "Review-finding fix attempt 1 taken on this agent PR (review-fix)"
L review-fix-2    "FBCA04" "Review-finding fix attempt 2 taken (review-fix)"
L review-fix-3    "FBCA04" "Review-finding fix attempt 3 taken (review-fix)"
L review-fix-4    "FBCA04" "Review-finding fix attempt 4 of 4 taken; the next findings verdict escalates to needs-human"
