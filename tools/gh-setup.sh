...
L auto-fix-2      "FBCA04" "CI auto-fix attempt 2 taken (ci-failure-router; bound = auto_fix_max_attempts)"
L auto-fix-3      "FBCA04" "CI auto-fix attempt 3 taken (ci-failure-router; bound = auto_fix_max_attempts)"
L auto-fix-4      "FBCA04" "CI auto-fix attempt 4 of 4 taken; the next failure escalates to needs-human"
