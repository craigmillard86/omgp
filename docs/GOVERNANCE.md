...
| WIP cap (`wip_cap` in .github/agent-config.yml, currently 4 (raised from 2, ruling 2026-09-20, #666 — measured 3% flow efficiency and both fix loops now bounded); stories in flight = open agent PRs ∪ claimed tasks, deduped per story; original ruling 2026-09-03) | review capacity governs autonomy; `wip_cap: 1` restores single-slot | dispatch workflow |
